...
; Polipo
LangString PolipoGroupDesc           ${LANG_ITALIAN} "Polipo è un proxy web filtrante che protegge la privacy e aiuta a rimuovere pubblicità (ad, banner e popup)."
