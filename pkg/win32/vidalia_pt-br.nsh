...
LangString BundleWelcomeText          ${LANG_PORTUGUESEBR} "Este assistente irá guia-lo através da instalação do Tor, Vidalia, Privoxy, and Torbutton.\r\n\r\nSe você já instalou previamente o Tor, Vidalia, Privoxy, ou Firefox, por favor certifique-se de que eles não estejam sendo executados antes de continuar esta instalação.\r\n\r\n$_CLICK"
...
LangString VidaliaWelcomeText         ${LANG_PORTUGUESEBR} "Este assistente irá guia-lo através da instalação do ${VIDALIA_DESC}.\r\n\r\n$_CLICK"
...
LangString TorbuttonAddToFirefoxDesc  ${LANG_PORTUGUESEBR} "Adicionar a extesão ${TORBUTTON_DESC} no Firefox."
