...
LangString BundleFinishText           ${LANG_FINNISH} "Asennus on valmis.\r\nOle hyv‰ ja tutustu http://tor.eff.org/docs/tor-doc-win32.html -ohjesivuun oppiakseen kuinka voi asettaa ohjelmat k‰ytt‰m‰‰n Tor-ohjelmaa.\r\n\r\nJos Torbutton on asennettu, niin Firefox t‰ytyy k‰ynnist‰‰ uudelleen."
...
LangString VidaliaWelcomeText         ${LANG_FINNISH} "T‰m‰ velho auttaa asentaakseen koneelle Vidalian, k‰yttˆliittym‰, jolla ohjataan, tarkkaillaan ja s‰‰det‰‰n Tor-ohjelmaa.\r\n\r\n$_CLICK"
...
LangString VidaliaShortcutsDesc       ${LANG_FINNISH} "Lis‰‰ ${VIDALIA_NAME} K‰ynnist‰-valikkoon."
LangString VidaliaRunNow              ${LANG_FINNISH} "K‰ynnist‰ ${VIDALIA_NAME} nyt"


; Tor
LangString TorGroupDesc               ${LANG_FINNISH} "Tor on j‰rjestelm‰, jolla voi k‰ytt‰‰ Internetti‰ tuntemattomasti muuttamalla sivujen selailun, pikaviestien k‰ytˆn,IRCin ja muut anonyymiseksi."
...
; Torbutton
LangString TorbuttonGroupDesc         ${LANG_FINNISH} "Torbutton on Mozilla Firefoxille lis‰osa, jolla voi ottaa k‰yttˆˆn tai poistaa k‰ytˆst‰ anonyymisen sivujen selailun."
...
LangString TorbuttonAddToFirefoxDesc  ${LANG_FINNISH} "Lis‰‰ ${TORBUTTON_DESC}-lis‰osa Mozilla Firefoxiin."
LangString TorbuttonFirefoxNotFound   ${LANG_FINNISH} "Mozilla Firefox-selainta ei lˆytynyt koneelta. Torbuttonia ei voitu asentaa."
